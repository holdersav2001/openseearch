...
def main(distribution_range, num_workers):
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_workers) as executor:
        # Each worker will handle a different distribution range
        futures = [executor.submit(fetch_and_insert_data, distribution_range, i, num_workers) for i in range(num_workers)]
